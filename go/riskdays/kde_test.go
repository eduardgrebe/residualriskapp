...
func TestKDEModeLog_Silverman(t *testing.T) {
	...
	mode := KDEModeLog(data, 10000, 0, 0)
...
func TestKDEModeLog_Reproducible(t *testing.T) {
	...
	m1 := KDEModeLog(data, 5000, 0, 0)
	m2 := KDEModeLog(data, 5000, 0, 0)
	if m1 != m2 {
...
func TestKDEModeLog_SingleValue(t *testing.T) {
	m := KDEModeLog([]float64{0.000673}, 1000, 0, 0)
	if m != 0.000673 {
